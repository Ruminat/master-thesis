...
%%
%%
\renewcommand{\thesisTitle}{Разработка и исследование системы автоматического упрощения текстов на японском языке}
\newcommand{\thesisDegree}{магистерская диссертация}% дипломный проект, дипломная работа, магистерская диссертация %c 2020
\newcommand{\thesisTitleEn}{Development and research of a Japanese texts automatic simplification system} %2020
...
%%
%%
\newcommand{\keywordsRu}{автоматическое упрощение текстов, японский язык, Transformer, нейронные сети, NLP} % ВВЕДИТЕ ключевые слова по-русски
%%
%%
\newcommand{\keywordsEn}{automatic text simplification, japanese language, Transformer, neural networks, NLP} % ВВЕДИТЕ ключевые слова по-английски
%%
%%
...
\newcommand{\abstractRu}{В данной работе описан подход к автоматическому упрощению текстов на японском языке посредством использования нейронной сети с архитектурой Transformer. Разработана система, состоящая из сервера и веб-приложения, реализующая алгоритм упрощения. Было проведено тестирование разработанной системы на нескольких предложениях на японском языке.} % ВВЕДИТЕ текст аннотации по-русски
%%
%%
\newcommand{\abstractEn}{This paper describes an approach to automatic simplification of Japanese texts through the use of a neural network with the Transformer architecture. A system has been developed that consists of a server and a web application that implements the simplification algorithm. The developed system was tested on several sentences in Japanese.} % ВВЕДИТЕ текст аннотации по-английски
