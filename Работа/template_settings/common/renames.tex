...
\newcommand{\thesisTitleEn}{Automated natural language text analysis and generation using artificial neural networks} %2020
...
%%
%%
\newcommand{\keywordsRu}{NLP, японский язык, русский язык, нейронные сети, генерация текста} % ВВЕДИТЕ ключевые слова по-русски
%%
%%
\newcommand{\keywordsEn}{NLP, japanese language, russian language, neural networks, text generation} % ВВЕДИТЕ ключевые слова по-английски
%%
%%
...
\newcommand{\abstractRu}{(черновик) Автоматическое реферирование и упрощение текстов на русском и японском языках.} % ВВЕДИТЕ текст аннотации по-русски
%%
%%
\newcommand{\abstractEn}{(draft) Automatic Russian and Japanese texts summarization and simplification.} % ВВЕДИТЕ текст аннотации по-английски
